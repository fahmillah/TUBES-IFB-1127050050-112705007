<%-- 
    Document   : index
    Created on : Dec 1, 2014, 7:43:36 AM
    Author     : erik
--%>
...
<html>
    <head>
        ...
        <title>Reservasi Rental Mobil </title>
    </head>
    <body bgcolor="azure">
    <div align="center">
      <table width="720" border="0" cellspacing="10" cellpadding="0">
        <tr>
          <td height="100%" valign="top"><div class="cart" align="right"><a href="controller?page=cart"><img src="images/sewa.jpg" width="33" height="32" /></a></div></td>
        </tr>
        <tr>
          <td height="100%" valign="top"><div class="add" align="right"><a href="login.jsp"><img src="images/tambah.jpg" width="33" height="32" /></a></div></td>
        </tr>
        <tr>
                      ...
                      <td width="530" height="98" valign="top" bgcolor="#A8A8FF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="70%" height="98" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="5">
                            ...
                            <tr>
                              <td><div align="right" class="button"><a href="controller?page=cart&prodid=${prod.id}"><img src="images/button1.png" width="60" height="20" /></a></div></td>
                            </tr>
                          </table></td>
                          </tr>
                      </table></td>
